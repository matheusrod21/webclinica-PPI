...
<main>
    <div class="container">
        ...
        <form class="row g-2" id="form_input">
            ...
            <div class="col-md-4">
                <div class="form-floating">
                    <input class="form-control" id="peso" name="peso" placeholder=" " type="text"/>
            ...
            <div class="col-md-4">
                <div class="form-floating">
                    <input class="form-control" id="altura" name="altura" placeholder=" " type="text"/>
            ...
            <div class="col-md-4">
                <div class="form-floating">
                    <input class="form-control" id="tipos" name="tipos" placeholder=" " type="text"/>
    ...
    <div class="rodape">
        ...
        <div class="mapa">
            <iframe allowfullscreen=""
                    height="200" loading="lazy" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1887.0900545011502!2d-48.286494991772166!3d-18.92342035954946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94a444f8f2f407cd%3A0x13b587c75013856b!2sR.%20Tiradentes%20-%20Fundinho%2C%20Uberl%C3%A2ndia%20-%20MG%2C%2038400-200!5e0!3m2!1spt-BR!2sbr!4v1647036787373!5m2!1spt-BR!2sbr" style="border:0;" width="200"></iframe>
            <!-- <h6>ENDEREÇO:</h6> -->
            <ul id="listarodape">
